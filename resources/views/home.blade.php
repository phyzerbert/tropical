    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2"><i class="fa fa-tachometer-alt mr-2"></i> Dashboard</h1>
        ...
        var dashboard_chart = function() {
            ...
            if (area_basic_element) {
                ...
                area_basic.setOption({
                    ...
                    color: ['#00ff00','#5ab1ef','#ff0000','#d87a80','#b6a2de'],
