    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2"><i class="far fa-file-alt"></i> {{__('page.edit_sale')}}</h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><i class="nav-main-link-icon si si-home"></i></li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('page.edit_sale')}}</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="content">
        <div class="block block-rounded block-bordered">
            <div class="block-content block-content-full">
                <form action="{{route('sale.update')}}" method="POST" enctype="multipart/form-data" id="app" style="opacity: 0">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="reference_no" value="{{$sale->reference_no}}" placeholder="{{__('page.reference_no')}}" required>
                                @error('reference_no')
                        ...
                        <div class="form-group col-lg-3 col-md-6">
                            ...
                            <input class="datepicker form-control" type="text" name="date" value="{{$sale->date}}" placeholder="{{__('page.date')}}" autocomplete="off" required>
                            @error('date')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control datepicker" type="text" name="due_date" value="{{$sale->due_date}}" placeholder="{{__('page.due_date')}}" autocomplete="off" required>
                                @error('due_date')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="customers_vat" value="{{$sale->customers_vat}}" required placeholder="{{__('page.customers_vat')}}">
                                @error('customers_vat')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="concerning_week" value="{{ $sale->concerning_week }}" required placeholder="{{__('page.concerning_week')}}">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="vessel" value="{{ $sale->vessel }}" required placeholder="{{__('page.vessel')}}">
                                @error('vessel')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="port_of_charge" value="{{ $sale->port_of_charge }}" required placeholder="{{__('page.port_of_charge')}}">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="port_of_discharge" value="{{ $sale->port_of_discharge }}" required placeholder="{{__('page.port_of_discharge')}}">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="origin" value="{{ $sale->origin }}" required placeholder="{{__('page.origin')}}">
                                @error('origin')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="week_c" value="{{ $sale->week_c }}" required placeholder="{{__('page.week_c')}}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label">{{__('page.week_d')}}</label>
                                <input class="form-control" type="text" name="week_d" value="{{ $sale->week_d }}" required placeholder="{{__('page.week_d')}}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
...
@section('script')
    ...
    <script src="{{asset('master/js/custom/edit_sale.js')}}"></script>
@endsection
