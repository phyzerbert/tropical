    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2"><i class="far fa-file-alt"></i> {{__('page.customer_sales')}}</h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><i class="nav-main-link-icon si si-home"></i></li>
                        <li class="breadcrumb-item" aria-current="page">{{__('page.customer')}}</li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('page.sales')}}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <form action="" class="col-md-12 form-inline px-0" method="post" id="searchForm">
                    ...
                    <a href="{{route('customer.sales', $customer->id)}}" class="btn btn-info btn-sm mt-2 mt-md-0 ml-auto"><i class="fa fa-credit-card"></i> {{__('page.sales')}}</a>
                    <a href="{{route('customer.payments', $customer->id)}}" class="btn btn-outline-info btn-sm mt-2 mt-md-0 ml-2"><i class="far fa-money-bill-alt"></i> {{__('page.payments')}}</a>
                </form>                
            </div>
