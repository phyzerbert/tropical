                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-align-primary">
                                                <a class="dropdown-item" href="{{route('customer.sales', $item->id)}}">{{__('page.view_reports')}}</a>
                                                <a class="dropdown-item" href="{{route('customer.report', $item->id)}}">{{__('page.report')}}</a>
                                                <a class="dropdown-item btn-edit" href="javascript:;" data-id="{{$item->id}}">{{__('page.edit')}}</a>
                                                <a class="dropdown-item" href="{{route('customer.delete', $item->id)}}" onclick="return window.confirm('{{__('page.are_you_sure')}}')">{{__('page.delete')}}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
