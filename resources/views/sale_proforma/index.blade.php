        ...
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <form action="" method="POST" class="col-md-12 form-inline px-0" id="searchForm">
                    ...
                    <a href="{{route('sale_proforma.create')}}" class="btn btn-success btn-sm mt-2 mt-md-0 ml-auto" id="btn-add"><i class="fa fa-plus"></i> {{__('page.add_new')}}</a>
                </form>
            </div>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-align-primary">
                                                ...
                                                <a class="dropdown-item" href="{{route('payment.index', ['sale_proforma', $item->id])}}">{{__('page.payment_list')}}</a>
