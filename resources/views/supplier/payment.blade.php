    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2"><i class="nav-main-link-icon si si-people"></i> {{__('page.supplier_payments')}}</h1>
        ...
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <form action="" class="col-md-12 form-inline px-0" method="post" id="searchForm">
                    ...
                    <a href="{{route('supplier.invoices', $supplier->id)}}" class="btn btn-outline-info btn-sm mt-2 mt-md-0 ml-auto"><i class="fa fa-credit-card"></i> {{__('page.invoices')}}</a>
                    <a href="{{route('supplier.payments', $supplier->id)}}" class="btn btn-info btn-sm mt-2 mt-md-0 ml-2"><i class="far fa-money-bill-alt"></i> {{__('page.payments')}}</a>
                </form>                
            </div>
