                ...
                <form action="{{route('sale.update')}}" method="POST" enctype="multipart/form-data" id="app" style="opacity: 0">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <input class="form-control datepicker" type="text" name="date" id="sale_date" value="{{date('Y-m-d H:i', strtotime($sale->timestamp))}}" placeholder="{{__('page.date')}}" autocomplete="off" required>
                                @error('date')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="reference_number" value="{{$sale->reference_no}}" required placeholder="{{__('page.reference_number')}}">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-layout-footer mt-5 text-right">
                                ...
                                <a href="{{route('sale.index')}}" class="btn btn-warning"><i class="fa fa-times"></i>  {{__('page.cancel')}}</a>
                            </div>
                        </div>
                    </div>
                </form>                
